...
public class SwaggerConfig {
	...
	private ApiInfo getApiInfo() {
		return new ApiInfo("User Payment API Documentation", "API for User Payment Microservice", "1.0", "Free to use",
				new springfox.documentation.service.Contact("Mukthesh", "http://Youtube.com",
						"radhamukthesh1@gmail.com"),
