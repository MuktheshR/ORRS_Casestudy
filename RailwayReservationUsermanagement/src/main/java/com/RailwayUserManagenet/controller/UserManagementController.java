...
public class UserManagementController {
	 ...
	 * @GetMapping("/{id}")
	 * 
	 * @ApiOperation(value = "To Get  User Details") public String
	 * findUsers(@Valid @PathVariable String id) { return
	 * (""+signUpService.getuser(id)); }
	 */

	/** This Method Is Used To Update Users By Id **/
	@PutMapping("/update/{id}")
	@ApiOperation(value = "To Update User Details")
	public String updateUser(@RequestBody UserSignUp userSignUp, @PathVariable String id) {
