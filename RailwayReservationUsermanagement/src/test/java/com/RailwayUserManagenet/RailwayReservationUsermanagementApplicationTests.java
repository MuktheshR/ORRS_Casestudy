...
class RailwayReservationUsermanagementApplicationTests {
	...
	public void addUsersTest() {
		UserSignUp userDetails = new UserSignUp("1", "Shuaib@gmail.com", 9895675645l, "shuaib123", "54321",
				"54321");
	...
	public void deleteUsersTest() {
		String rid = "102";
		signUpService.deleteUser((String) rid);
		verify(userSignUpRepository, times(1)).deleteById((String) rid);
	}
