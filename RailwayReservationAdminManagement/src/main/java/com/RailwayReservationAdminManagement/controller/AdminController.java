...
import com.RailwayReservationAdminManagement.service.SequenceGeneratorService;
...
public class AdminController {
	...
	public String addTrainDetails( @RequestBody TrainDetails trainDetails) {
		trainDetails.setTrainNo(sequenceGeneratorService.getSequenceNumber(TrainDetails.SEQUENCE_NAME));
	...
	public String updateTrainDetails(@PathVariable Integer trainNo,
		 @RequestBody TrainDetails trainDetails) {
