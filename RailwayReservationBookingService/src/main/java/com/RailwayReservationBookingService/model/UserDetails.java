...
public class UserDetails {
	...
	public UserDetails(@NotNull int id, @NotNull long pnrNo,
			...
			@NotNull @Size(max = 6, message = "Either male,female or other ") String sex, @NotNull String mailId,
...
//	}
	...
	public String toString() {
		return "UserDetails [id=" + id + ", pnrNo=" + pnrNo + ", name=" + name + ", age=" + age + ", sex=" + sex
				+ ", mailId=" + mailId + ", address=" + address + ", trainNo=" + trainNo + ", trainName=" + trainName
				+ ", sourceStation=" + sourceStation + ", destinationStation=" + destinationStation + ", classType="
				+ classType + ", adults=" + adults + ", children=" + children + ", payment=" + payment + "]";
	}
